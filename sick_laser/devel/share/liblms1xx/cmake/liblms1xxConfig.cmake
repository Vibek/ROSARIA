...
if("TRUE" STREQUAL "TRUE")
  set(liblms1xx_SOURCE_PREFIX /home/seekurjr/sick_laser/src/liblms1xx)
  set(liblms1xx_DEVEL_PREFIX /home/seekurjr/sick_laser/devel)
  ...
  set(liblms1xx_INSTALL_PREFIX /home/seekurjr/sick_laser/install)
...
if(NOT "/home/seekurjr/sick_laser/src/liblms1xx/src" STREQUAL "")
  set(liblms1xx_INCLUDE_DIRS "")
  set(_include_dirs "/home/seekurjr/sick_laser/src/liblms1xx/src")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'liblms1xx' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/seekurjr/sick_laser/src/liblms1xx/${idir}'.  Ask the maintainer 'kp <kp@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/seekurjr/sick_laser/devel/lib;/opt/ros/groovy/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND liblms1xx_LIBRARIES ${${liblms1xx_dep}_LIBRARIES})
...
if(liblms1xx_LIBRARIES)
  _remove_duplicate_libraries(liblms1xx_LIBRARIES liblms1xx_LIBRARIES)
endif()
